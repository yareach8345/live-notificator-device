...
void test_parse_live_state() {
    ...
    const LiveState* live_close = parse_live_state_from_json(live_close_doc["liveState"].as<JsonObjectConst>());
    const LiveState* live_open = parse_live_state_from_json(live_open_doc["liveState"].as<JsonObjectConst>());
